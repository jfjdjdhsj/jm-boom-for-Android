...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex flex-col gap-0.5 p-4 group-data-[vaul-drawer-direction=left]/drawer-content:pt-[calc(var(--app-safe-top)+1rem)] group-data-[vaul-drawer-direction=right]/drawer-content:pt-[calc(var(--app-safe-top)+1rem)] group-data-[vaul-drawer-direction=top]/drawer-content:pt-[calc(var(--app-safe-top)+1rem)] group-data-[vaul-drawer-direction=bottom]/drawer-content:text-center group-data-[vaul-drawer-direction=top]/drawer-content:text-center md:gap-1.5 md:text-left',
        className
      )}
      {...props}
    />
...
function DrawerFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'mt-auto flex flex-col gap-2 p-4 group-data-[vaul-drawer-direction=bottom]/drawer-content:pb-[calc(var(--app-safe-bottom)+1rem)] group-data-[vaul-drawer-direction=left]/drawer-content:pb-[calc(var(--app-safe-bottom)+1rem)] group-data-[vaul-drawer-direction=right]/drawer-content:pb-[calc(var(--app-safe-bottom)+1rem)]',
        className
      )}
      {...props}
    />
